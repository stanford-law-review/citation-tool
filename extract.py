...
def main():
    ...
    parser = argparse.ArgumentParser(description="SLR Citation Tool: A Simple Article Draft Processing Tool for Law Journals")

    # Modality argument: either body, footnotes, or citations
    parser.add_argument('mode', choices=['body', 'footnotes', 'citations'],
    ...
    parser.add_argument('input_file', type=str, help="Path to the input Word document (.docx)")

    # AI Config file (only for 'citations' mode)
    parser.add_argument('--ai_config_file', type=str, default='ai_config.json',
    ...
    parser.add_argument('--num_acknowledgment_footnotes', type=int, default=1,
    ...
    parser.add_argument('--enable_markup', action='store_true',
