...
class TestAIParseCitations(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open(os.path.join(self.test_data_dir, 'ai_parser_test_input.txt'), 'r') as f:
            self.test_cases = f.readlines()
        
        with open(os.path.join(self.test_data_dir, 'ai_parser_test_output.txt'), 'r') as f:
    ...
    def update_output(self):
        with open(os.path.join(self.test_data_dir, 'ai_parser_test_output.txt'), 'w') as f:
